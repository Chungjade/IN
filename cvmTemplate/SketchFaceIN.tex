...
In modern deep neural network, normalization layers play an important role for stabilizing the training process. 
...
A coarse-to-fine generator and a multiscale discriminator are introduce to increase the image resolution and enhance texture details.
...
The five feature vectors are denoted as $\boldsymbol{v}_k,~k=0,\ldots,4$ in dimensions of 48, 96, 192, 384 and 768, respectively. 
...
%
It can be seen that the data of G1, G2, G3 and G4 are distributed at a same point separately, the data of G8 and G11 are gathered on the same point, the data of G9 and G10 are distributed at the same point, whereas the data of G5, G6 and G7 are distributed dispersedly. 
