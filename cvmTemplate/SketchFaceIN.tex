...
\paragraph{Datasets.}
CelebA-HQ dataset contains more than 30,000 face images in resolution $1024\times1024$. All the face images are cropped and globally aligned according to face landmarks.
...
After \nt{removing the photos for which landmark extraction fails}, the training set contains 14,973 pairs of contour image and face photo, while the test set contains 4,992 pairs of contour and face photo. 
...
\begin{figure}[htb]
	...
	\caption{Comparison between images generated \nt{with and without} data augmentation. }
...
Extensive experiments demonstrate the effectiveness of our proposed method on the image quality and conformance with user intention in an
sketch-based face image generation system.  
