...
% Single address.
% ---------------
\name{Zhihua Cheng, Xuejin Chen, Binxin Yang, Zihan Chen}
...
%
\begin{keywords}
Sketch-based, face image generation, Instance normalization, fine-grained control, generative adversarial networks
\end{keywords}
%
...
To further explore how the amount of instance normalization layers in generator network affect the sketch-based face image generation quality, we train another model which takes the generator of pix2pixHD got rid of the first five instance normalization layers as its own generator. 
...
\begin{figure}[htb]
	...
	\caption{Comparison between results generated by different models with different amount of instance normalization layers. }
	\label{fig:ablation}
\end{figure}  
